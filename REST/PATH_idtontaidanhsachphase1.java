...
public class KLC7ELUf {

    static final String STUDENT_CODE = "B22DCAT134";
    static final String QCODE = "KLC7ELUf";
...
//b. Server trả về requestId và data là danh sách invoice, mỗi invoice có id, customer, totalVND.

//c. Chọn một id tồn tại trong danh sách phase 1.

//d. Gửi GET /api/rest/path/{invoiceId}?studentCode=<mã_sinh_viên>&qCode=<qAlias>&requestId=<requestId>&currency=USD.

//e. invoiceId phải hợp lệ, requestId phải đúng, và currency phải bằng USD.
